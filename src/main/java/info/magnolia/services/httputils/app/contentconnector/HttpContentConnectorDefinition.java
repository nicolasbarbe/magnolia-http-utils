...
public class HttpContentConnectorDefinition extends ConfiguredContentConnectorDefinition implements ContentConnectorDefinition {

    private String serviceName;

    public HttpContentConnectorDefinition() {
       setImplementationClass(HttpContentConnectorImpl.class);
   }
